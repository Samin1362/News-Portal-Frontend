...
/**
 * Profile editor rendered inside the dashboard shell — same form as the
 * public `/profile` page but laid out as a normal dashboard outlet so the
 * sidebar / topbar / bottom-tabs stay in view.
 */
export default function DashboardProfilePage() {
  ...
  return (
    <>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-4 items-start">
        <div className="border-[1.5px] border-ink rounded-sm bg-paper p-5 card-hov">
          <div className="font-hand text-[11px] text-muted uppercase tracking-[0.12em]">
            Account
          </div>
          <div className="mt-2 font-sans text-[14px] break-all">
            {profile.email}
          </div>
          ...
          {profile.photoURL ? (
            <div className="mt-4">
              <div className="font-hand text-[11px] text-muted uppercase tracking-[0.12em] mb-2">
                Current avatar
              </div>
              ...
              <img
                ...
                className="w-20 h-20 rounded-full border-[1.5px] border-ink object-cover"
              />
            </div>
          ) : null}
        </div>
        ...
        <form
          className="border-[1.5px] border-ink rounded-sm bg-paper p-5 space-y-4"
